...
- **CAD**: Engineers create 3D models, run crash simulations, and optimize aerodynamics
- **CAM**: Robotic assembly lines position components with sub-millimetre precision
- **TQM**: Real-time sensors monitor quality, detect defects, and trigger corrections

**In Computer-Assisted Surgical Interventions**
- **CAD**: Surgical planning. Surgeons create patient-specific plans that may include 3D models of patient anatomy, simulation of procedures, and optimization of surgical approaches
- **CAM**: Surgical execution. Surgeons use advanced mechatronics such as surgical navigation systems or medical robotics to guide surgical instruments with sub-millimetre accuracy to surgical targets
- **TQM**: Surgical assessment. Surgical outcomes are recorded, complications are identified, and used to improve future procedures
...
1. **Quality Control**: How do we know if what was planned and executed was effective? Past outcomes can be analyzed to provide insight for further surgery; thus the **quality control** stage provides feedback for this closed-loop process of CAI.
...
- **Preoperative imaging** (X-ray, Computed Tomography, Magnetic Resonance Imaging, ultrasound) provides detailed anatomical information for surgical planning.
- **Intraoperative imaging** (ultrasound, fluoroscopy) provides real-time updates during procedures,
- **Mixed-reality systems** overlays enhance the surgeon's view of the patient.

### Surgical Navigation
Akin to GPS for driving navigation, surgical navigation systems track surgical instruments relative to patient anatomy:
- **Optical tracking systems** use cameras to track markers on the patient or surgical instruments,
- **Magnetic tracking systems** enable localization of both rigid and flexible surgical instruments,
...
This course focuses on computer-assisted surgery (CAS), a subdiscipline of computer-assisted interventional medicine. As an introductory course, we will explore the fundamental principles and technologies that underpin this rapidly evolving field. While we will develop a solid foundation in core concepts, from surgical metrology to image registration and system implementation, it is important to recognize that computer-assisted interventional medicine remains an area of active research. New techniques, technologies, and clinical applications continue to emerge, making this an exciting time to enter the field. The knowledge and skills you acquire in this course will provide you with the essential tools to understand current systems and contribute to future innovations in computer-integrated interventional medicine.